      ...
      <div slot="header" class="clearfix">
        ...
        <el-tabs v-model="activeName" class="tabs" @tab-click="handleClickTab">
          <el-tab-pane label="销售额" name="sale">
            <el-row :gutter="10" v-if="activeName == 'sale'">
              <el-col :span="18" class="col_18">
                <div class="charts" ref="charts"></div>
              </el-col>
              <el-col :span="6" class="col_6">
                <div style="font-size: 14px">门店销售额排名</div>
                <ul>
                  <li>
          ...
          <el-tab-pane label="访问量" name="visits">
            <el-row :gutter="10" v-if="activeName == 'visits'">
              <el-col :span="18" class="col_18">
                <div class="charts" ref="charts"></div>
              </el-col>
              <el-col :span="6" class="col_6">
  ...
  methods: {
    ...
    getEcharts() {
      ...
      if (this.activeName == "visits") {
        this.rankName = "访问量";
        let option2 = mycharts.getOption();
        option2.series[0].data = [
          100, 152, 233, 334, 350, 497, 226, 252, 133, 42, 13, 74,
        ];
        option2.title[0].text = "访问量趋势";
